...
<template>
    ...
    <BlogLayout>
        <nav class="mb-6 text-sm text-muted-foreground">
            <Link href="/blog" class="hover:text-foreground">← Blogi</Link>
        </nav>

        <article class="rounded-xl border border-border/80 bg-card p-6 shadow-sm">
        ...
        <section class="mt-10 rounded-xl border border-border/80 bg-card p-6 shadow-sm">
